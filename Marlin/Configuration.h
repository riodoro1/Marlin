...
#define STRING_CONFIG_H_AUTHOR "(Rafal Bialek, bialek.rafal@gmail.com)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_RADIUS 110.2              // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 148.700 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27.2, -16, -1 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), 0, 50 }
